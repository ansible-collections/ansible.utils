...
class TestIpAddr(unittest.TestCase):
    ...
    def test_invalid_data(self):
        ...
        with self.assertRaises(AnsibleFilterError) as error:
            _ipmath(*args, **kwargs)
        assert "You must pass a valid IP address" in str(error.exception)
