...
DOCUMENTATION = """
    ...
    description:
        ...
        - Using the parameters below- B(var|ansible.utils.get_path(path, wantlist))
    options:
      var:
        description:
        ...
        - For example B(config_data|ansible.utils.get_path()), in this case B(config_data) represents this option.
        type: raw
        required: True
      path:
        description:
