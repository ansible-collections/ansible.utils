...
- name: validate data in json format using jsonschema with filter plugin
...
def validate(*args, **kwargs):
    ...
    argspec_result, updated_params = check_argspec(yaml.dump(argspec_obj), "action", schema_conditionals=ARGSPEC_CONDITIONALS, **params)
