...
def validate(*args, **kwargs):
    if not len(args):
        raise AnsibleError("Missing either 'data' value in test plugin input,"
    ...
    argspec_result, updated_params = check_argspec(yaml.dump(argspec_obj), "test", schema_conditionals=ARGSPEC_CONDITIONALS, **params)
