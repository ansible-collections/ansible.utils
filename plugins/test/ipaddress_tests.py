...
#     """Test if an IP or network is in one network<br/>`'10.1.1.1' is ansible.utils.in_one_network ['10.0.0.0/8', '192.168.1.0/24']`
#     """
...
# @_need_ipaddress
# def _ip(ip):
#     """Test if something in an IP address or network<br/>`'10.1.1.1' is ansible.utils.ip`
#     """
#     try:
#         ip_network(ip)
#         return True
...
def _ipv4_netmask(mask):
    """ Test for a valid IPv4 netmask<br/>`'255.255.255.0' is ansible.utils.ipv4_netmask`
    """
    try:
...
def _supernet_of(network_a, network_b):
    """Test if an network is a supernet of another network<br/>`'10.0.0.0/8' is ansible.utils.supernet_of '10.1.1.0/24'`
    """
    try:
